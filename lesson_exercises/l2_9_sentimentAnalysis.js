...
input: string, text textExcerpt
output: strings covering positive and negative sentiments
       and overall sentiment

Algorithm:
obtain words in an array of lowercase words
iterate over positiveWords
check if current positiveWord has match and move to array of `positives` if so
same for `negatives`
output correpsonding messages
/**/ /**/ /**/ /**/ /**/
...
function output(positives, negatives) {
  ...
  console.log('');
  console.log(`There are ${negatives.length} positive words in the text.`);
